...
const UI = {
    ...
    start() {
        ...
        // LL Hack to force websockify relative path & autoconnect
        var t_dir = window.location.pathname;
        var t_dir = t_dir.substring(0, t_dir.lastIndexOf('/'));
        var t_dir = t_dir.substring(1);
        UI.forceSetting('path', t_dir + '/websockify');
